      ...
      <div className="animals">
        {Actvidad.map((acti) => (
          <div className="actividad-details">
            <h2 className="actividad" style={{ fontWeight: "bold" }}>
              {acti.actividad}
            </h2>
            <p className="dateAndPlace">
              ...
              {acti.fecha} {" - "}{" "}
              <BiTimeFive style={{ marginRight: "5px", color: "#C0D904" }} />
              {acti.tiempo}
            </p>
            <h5>Descripción</h5>
            <p
