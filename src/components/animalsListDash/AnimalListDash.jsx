    ...
    return (
      <div >
        <div style={{width:"100%", margin:"10px"}} >
                <Link style={{width:"90%", backgroundColor:"#2a411c"}} to="/AnimalForm"  className="btn rounded-pill btn-block">
                <span style={{ color: 'white', fontSize:"30px" }}>Añadir Nuevo Animal</span>
            </Link>
      ...
      {animals.map(item => (
          ...
          <div className="card" >
            <div className="row">
              ...
              <Link to={`/AnimalForm/${item.idAnimal}`} style={{color:"black"}} className="me-2">
